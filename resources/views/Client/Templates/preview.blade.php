...
<body class="bg-gray-100">
    ...
    <div class="container mx-auto px-4 py-8">
        ...
        <div class="flex justify-between mb-8">
            ...
            <a href="{{route('Client.Templates.cost')}}" class="text-center">
    ...
    <div class="flex mb-4">
        <div class="w-2/3 pr-2">
            <img src="{{ asset('template/img\fabric.png') }}" alt="Fabric sample" class="w-full h-48 object-cover rounded-lg">
        </div>
    ...
    <div class="grid grid-cols-2 gap-4 mb-4">
        <img src="{{ asset('template/img/big fabric.png') }}" alt="Main Style" class="w-full h-40 object-cover rounded-lg">
    ...
    <div class="mt-8 bg-white p-6 rounded-lg shadow-md">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div class="col-span-2">
                <img src="{{ asset('template/img/body measurement.png') }}" alt="Body measurement diagram" class="w-full h-64 object-contain mb-4">
