            ...
            <div class="bg-gray-100 rounded-lg shadow p-6">
                ...
                <div class="bg-white rounded-lg p-4 mb-4">
                    ...
                    <div class="flex items-center justify-between">
                        <div class="flex items-center">
                            <img src="{{ asset('template/img/woman.png') }}" alt="Product" class="w-24 h-24 object-cover rounded mr-4">
                            <div>
                ...
                <div class="flex justify-between items-center mb-4">
                    <div class="flex items-center">
                        ...
                        <a href="{{route('Client.Templates.customization')}}" class="font-semibold">Customized Order</a>
                    </div>
                    <div class="flex items-center">
